...
| Max database size | Up to currently available instance size (max 2 TB - 8 TB depending on the number of vCores and max 16 TB in Preview). | Up to currently available instance size (max 1 TB - 4 TB depending on the number of vCores). |
